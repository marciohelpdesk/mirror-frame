    ...
    <div className="flex flex-col h-full relative z-10 overflow-y-auto hide-scrollbar pb-32">
      ...
      <div className="sticky top-0 z-20 bg-transparent backdrop-blur-xl px-6 py-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="text-[10px] text-white/70 font-medium uppercase tracking-wider">{t('properties.manage') || 'Gerenciar'}</p>
            <h1 className="font-bold text-white text-2xl">{t('properties.title')}</h1>
          </div>
